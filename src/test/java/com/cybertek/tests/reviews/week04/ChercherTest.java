...
public class ChercherTest {
    ...
    */
    ...
    public void disabledButtonTest(){
        ...
        WebElement btnInitiator = driver.findElement(By.id("enable-button"));
        btnInitiator.click();
        ...
        System.out.println("button.isEnabled() = " + button.isEnabled());
        Assert.assertTrue(button.isEnabled(),"Verify button is NOT DISABLED");
    }
    ...
    public void displayButtonTest(){
        ...
        wait = new WebDriverWait(driver, 10);
        WebElement button = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("hidden")));
